...
func (r *CodeReviewRunner) prepareRepository(ctx context.Context, git adapters.GitService, repoURL, branch string) error {
...
func (r *CodeReviewRunner) cleanupGit(ctx context.Context, git adapters.GitService) {
