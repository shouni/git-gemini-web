...
| 要素 | 基準 |
| :--- | :--- |
| **【判定】** | 以下のいずれか一つを記述してください。<br> - `Blocker`：直ちに修正が必要なクリティカルな問題（致命的なバグ、セキュリティ脆弱性、重大なパフォーマンス劣化など）が見つかった場合。<br> - `Major`：Blocker ではないが、リリース前に強く修正すべき問題（深刻な保守性の欠如、N+1問題など）がある場合。<br> - `Minor`：Blocker / Major はないが、軽微な改善点がある場合。<br> - `None`：クリティカルな問題が見つからなかった場合。 |
